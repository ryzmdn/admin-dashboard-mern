...
export default function Login() {
  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center w-full min-h-screen px-6 py-12 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <button type="button" onClick={handleOpen} className="font-semibold text-gray-800 hover:text-gray-700">
                    Forgot password?
                  </button>
                </div>
              </div>
          ...
          <p className="mt-10 text-center text-sm/6 text-gray-500">
            ...
            <Link to="/register" className="font-semibold text-gray-800 hover:text-gray-700">
              Create new account
            </Link>
          </p>
